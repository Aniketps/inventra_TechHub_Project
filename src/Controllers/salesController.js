...
exports.addSale = async(req, res)=>{
    if(!req.body.stockID, !req.body.purchaseDate, !req.body.quantity, !req.body.discount, !req.body.tax, !req.body.totalBill, !req.body.customerID) return res.status(400).json({"error" : "QUERY ISSUE", "message" : "Please provide data along with request"});
    try{
        ...
        if(!stockID, !quantity, !discount, !tax, !totalBill, !customerID) return res.status(104).json({"error" : "QUERY ISSUE", "message" : "Insufficient data input"});
...
exports.updateSaleByID = async(req, res)=>{
    if(!req.params.id || !req.body.stockID || !req.body.quantity || !req.body.discount || !req.body.tax || !req.body.totalBill || !req.body.customerID) return res.status(400).json({"error" : "QUERY ISSUE", "message" : "Please provide data and id"});
    try{
